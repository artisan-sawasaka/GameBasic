...
#ifndef _CRI_ATOMEX_MONITOR_H
#define _CRI_ATOMEX_MONITOR_H
...
/* バージョン情報 */
/* Version Number */
#define CRIATOMEX_MONITOR_VERSION				(0x01090000)
#define CRIATOMEX_MONITOR_VER_NUM				"1.09.00"
